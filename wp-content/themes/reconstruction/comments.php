...
<div id="comments" class="commentsBox">
	...
	<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			if ( $prev_html != '' && $next_html != '' ) {
				echo get_previous_comments_link( __( 'Older Comments', 'bt_theme' ) );
				echo '<span>|</span>';
				echo get_next_comments_link( __( 'Newer Comments', 'bt_theme' ) );
			} else {
				echo get_previous_comments_link( __( 'Older Comments', 'bt_theme' ) );
				echo get_next_comments_link( __( 'Newer Comments', 'bt_theme' ) );
			}
	...
	<?php 
		...
		$args = array(
		  ...
		  'submit_button' => '<div class="boldBtn btnAccent btnSmall btnIco"><button type="submit" value="' . __( 'Post Comment', 'bt_theme' ) . '" id="btSubmit" name="submit" class="" data-ico-bold="&#xe60a;">' . __( 'Post Comment', 'bt_theme' ) . '</button></div>',
